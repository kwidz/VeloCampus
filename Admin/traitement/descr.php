    ...
    if(isset($_GET['id'])){
        ...
        echo '<tr><td style="border:solid 1px #CDCACA;font-weight:bold;color:RoyalBlue">&nbspDATE DE NAISSANCE&nbsp</td><td style="border:solid 1px #CDCACA">&nbsp'.$date_fr.'&nbsp</td></tr>';
