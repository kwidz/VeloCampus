...
INSERT INTO `Admin` VALUES (1,'Admin','09566ed3acd8c475d2396dbe3d4636a4');
...
/*INSERT INTO `Membres` (`id_Membre`, `nom_membre`, `biographie`, `photo`) VALUES
(null, 'Delaunay D̩borah ', 'Etudiante DUT CS Gestion Urbaine', 'Pr̩sidente', '../images/membres/DSC_3661.JPG'),
(null, 'Henri Dabere', 'DUT informatique ', 'Tr̩sorier', '../images/membres/face.jpg');*/
...
CREATE TABLE `_Type` (
  ...
  `caracteristiques_type` text DEFAULT NULL,
