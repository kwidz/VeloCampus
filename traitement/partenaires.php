...
if ($result) {
  ...
  for ($i=0; $i < $nbPar; $i++) { 
    if ($i == $nbPar-1 && $nbPar%2 == 1) {
      ...
      echo "<tr><td><center><h3>".$nom[$i]."</h3></center></td><td><center><h3>".$nom[$i+1]."</h3></center></td></tr><tr><td><center><i>".$description[$i]."</i></center><br/></td><td><center><i>".$description[$i+1]."</i></center><br/></td></tr><tr><td><center><img heigth='200px' width='200px' src='../Admin/partenaires/".$photo[$i]."'></img><br/><br/><br/><br/></center></td><td><center><img heigth='200px' width='200px' src='../Admin/partenaires/".$photo[$i+1]."'></img><br/><br/><br/><br/></center></td></tr>";
      $i++;
    }
  }
  echo "</table></center>";
